...
---@field sell_leg_classcode string Код класса инструмента ноги на продажу
---@field sell_leg_seccode string Код инструмента ноги на продажу
---@field first_currcode string Код котируемой валюты в паре
---@field second_currcode string Код базовой валюты в паре
---@field buy_leg_classcode string Код класса инструмента ноги на покупку
---@field buy_leg_seccode string Код инструмента ноги на покупку
---@field base_active_classcode string Код класса базового актива
---@field base_active_seccode string Базовый актив
---@field buy_mat_date number Дата расчетов сделки на покупку
---@field sell_mat_date number Дата расчетов сделки на продажу
...
---@field awg_price number Средняя цена приобретения. Актуально, когда заявка выполнилась частями
...
---@field price_currency string Валюта цены заявки
...
---@field brokerref nil|string Поручение
...
---@field in_assets string Оценка собственных средств клиента до начала торгов Вход. активы
---@field leverage string Плечо. Если не задано явно, то отношение Входящего лимита к Входящим активам Плечо
---@field open_limit string Оценка максимальной величины заемных средств до начала торгов Вход. лимит
---@field val_short string Оценка стоимости коротких позиций. Значение всегда отрицательное Шорты
---@field val_long string Оценка стоимости длинных позиций Лонги
---@field val_long_margin string Оценка стоимости длинных позиций по маржинальным инструментам, принимаемым в обеспечение Лонги МО
---@field val_long_asset string Оценка стоимости длинных позиций по немаржинальным инструментам, принимаемым в обеспечение Лонги О
---@field assets string Оценка собственных средств клиента по текущим позициям и ценам Тек. активы
---@field cur_leverage string Текущее плечо Тек.плечо
---@field margin string Уровень маржи, в процентах Ур. маржи
---@field lim_all string Текущая оценка максимальной величины заемных средств Тек. лимит
---@field av_lim_all string Оценка величины заемных средств, доступных для дальнейшего открытия позиций ДостТекЛимит
---@field locked_buy string Оценка стоимости активов в заявках на покупку Блок. покупка
---@field locked_buy_margin string Оценка стоимости активов в заявках на покупку маржинальных инструментов, принимаемых в обеспечение Блок. пок. маржин.
---@field locked_buy_asset string Оценка стоимости активов в заявках на покупку немаржинальных инструментов, принимаемых в обеспечение Блок.пок. обесп.
---@field locked_sell string Оценка стоимости активов в заявках на продажу маржинальных инструментов Блок. продажа
---@field locked_value_coef string Оценка стоимости активов в заявках на покупку немаржинальных инструментов Блок. пок. немарж.
---@field in_all_assets string Оценка стоимости всех позиций клиента в ценах закрытия предыдущей торговой сессии, включая позиции по немаржинальным инструментам ВходСредства
---@field all_assets string Текущая оценка стоимости всех позиций клиента ТекСредства
---@field profit_loss string Абсолютная величина изменения стоимости всех позиций клиента Прибыль/убытки
---@field rate_change string Относительная величина изменения стоимости всех позиций клиента ПроцИзмен
---@field lim_buy string Оценка денежных средств, доступных для покупки маржинальных инструментов На покупку
---@field lim_sell string Оценка стоимости маржинальных инструментов, доступных для продажи На продажу
---@field lim_non_margin string Оценка денежных средств, доступных для покупки немаржинальных инструментов НаПокупНеМаржин
---@field lim_buy_asset string Оценка денежных средств, доступных для покупки инструментов, принимаемых в обеспечение НаПокупОбесп
---@field val_short_net string Оценка стоимости коротких позиций. При расчете не используется коэффициент дисконтирования *Шорты (нетто)
---@field val_long_net string Оценка стоимости длинных позиций. При расчете не используется коэффициент дисконтирования *Лонги (нетто)
---@field total_money_bal string Сумма остатков по денежным средствам по всем лимитам, без учета средств, заблокированных под исполнение обязательств, выраженная в выбранной валюте расчета Сумма ден. остатков
---@field total_locked_money string Cумма заблокированных средств со всех денежных лимитов клиента, пересчитанная в валюту расчетов через кросс-курсы на сервере Суммарно заблок.
---@field haircuts string Сумма дисконтов стоимости длинных (только по инструментам обеспечения) и коротких позиций по инструментам, дисконтов корреляции между инструментами, а также дисконтов на задолженности по валютам, не покрытые обеспечением по инструментам в этих же валютах Сумма дисконтов
...
---@field status_coef string Отношение суммы дисконтов к текущим активам без учета дисконтов Статус счета
---@field varmargin string Текущая вариационная маржа по позициям клиента, по всем инструментам Вариац. маржа
---@field go_for_positions string Размер денежных средств, уплаченных под все открытые позиции на срочном рынке ГО поз.
---@field go_for_orders string Оценка стоимости активов в заявках на срочном рынке ГО заяв.
---@field rate_futures string Отношение ликвидационной стоимости портфеля к ГО по срочному рынку Активы/ГО
---@field is_qual_client string Признак квалифицированного клиента, которому разрешено кредитование заемными средствами с плечом 1:3. Возможные значения: "ПовышУрРиска" – квалифицированный, <пусто> – нет ПовышУрРиска
---@field is_futures string Счет клиента на FORTS, в случае наличия объединенной позиции, иначе поле остается пустым Сроч. счет
---@field curr_tag string Актуальные текущие параметры расчета для данной строки в формате "<Валюта>-<Код позиции>". Пример: "SUR-EQTV" Парам. расч.
...
---@class fngetPortfolioInfoExReturn
---@field init_margin string Значение начальной маржи. Заполняется для клиентов типа "МД" Нач.маржа
---@field min_margin string Значение минимальной маржи. Заполняется для клиентов типа "МД" Мин.маржа
---@field corrected_margin string Значение скорректированной маржи. Заполняется для клиентов типа "МД" Скор.маржа
---@field client_type string Тип клиента Тип клиента
---@field portfolio_value string Стоимость портфеля. Для клиентов типа "МД" возвращается значение для строк с максимальным сроком расчётов limit_kind Стоимость портфеля
---@field start_limit_open_pos string Лимит открытых позиций на начало дня ЛимОткрПозНачДня
---@field total_limit_open_pos string Лимит открытых позиций ЛимОткрПоз
---@field limit_open_pos string Планируемые чистые позиции ПланЧистПоз
---@field used_lim_open_pos string Текущие чистые позиции ТекЧистПоз
---@field acc_var_margin string Накопленная вариационная маржа НакопВарМаржа
---@field cl_var_margin string Вариационная маржа по итогам промклиринга ВарМаржаПромклир.
---@field opt_liquid_cost string Ликвидационная стоимость опционов ЛиквСтоимОпционов
---@field fut_asset string Сумма оценки средств клиента на срочном рынке СумАктивовНаСрчРынке
---@field fut_total_asset string Сумма оценки собственных средств клиента на фондовом и срочном рынках ПолнСтоимостьПортфеля
---@field fut_debt string Текущая задолженность на срочном рынке ТекЗадолжНаСрчРынке
---@field fut_rate_asset string Достаточность средств Дост. Средств
---@field fut_rate_asset_open string Достаточность средств (под открытые позиции) Дост. Средств (ОткрПоз)
---@field fut_rate_go string Коэффициент ликвидности ГО КоэффЛикв ГО
---@field planed_rate_go string Ожидаемый коэффициент ликвидности ГО Ожид. КоэффЛикв ГО
---@field cash_leverage string Cash Leverage Cash Leverage
---@field fut_position_type string Тип позиции на срочном рынке. Возможные значения "0" – нет позиции; "1" – фьючерсы; "2" – опционы; "3" – фьючерсы и опционы ТипПозНаСрчРынке
---@field fut_accured_int string Накопленный доход с учётом премии по опционам и биржевым сборам НакопДоход
---@field rcv1 string Норматив покрытия риска 1. Рассчитывается как разница параметров "Стоимость портфеля" и "Начальная маржа". Для клиентов типа "МД" и "МД+" нпр1
---@field rcv2 string Норматив покрытия риска 2. Рассчитывается как разница параметров "Стоимость портфеля" и "Минимальная маржа". Для клиентов типа "МД" и "МД+" нпр2

---Функция предназначена для получения значений параметров таблицы "Клиентский портфель", соответствующих идентификатору участника торгов `firm_id`, коду клиента `client_code` и сроку расчётов `limit_kind`. \
--- \
...
---@return fngetPortfolioInfoExReturn
...
---Функция возвращает "true", если окно с таблицей `t_id` закрыто. Окно может быть открыто повторно с помощью функции `CreateWindow`. \
--- \
